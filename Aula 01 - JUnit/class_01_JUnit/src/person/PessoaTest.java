...
class PessoaTest {
    ...
    void adicionarColecao() {
        colecao.add(p1.adicionarNome(p1));
        colecao.add(p2.adicionarNome(p2));
        colecao.add(p3.adicionarNome(p3));
        colecao.add(p4.adicionarNome(p4));
        colecao.add(p5.adicionarNome(p5));
        colecao.add(p6.adicionarNome(p6));
        colecao.add(p7.adicionarNome(p7));
        colecao.add(p8.adicionarNome(p8));
        colecao.add(p9.adicionarNome(p9));
        colecao.add(p10.adicionarNome(p10));
